						...
						<div class="form-group mb-4">
                                ...
                                <div class="media">
                                	<div class="media-left">
                                    	...
                                    	style="vertical-align: middle; width: 4rem; height: 4rem;" src="https://cdn.postype.com/assets/img/avatar/blog_blank_n.png">
                                    </div>
                                    <div class="media-body">
                                        <div class="form-control">
                                            <label class="sr-only" for="upload-profile-photo">파일 선택</label>
                                            <input type="hidden" name="target" value="user_temp">
                                            <input type="hidden" name="target_id" value="512379">
                         ...
                         <div class="form-group mb-4">
                         	<label>블로그 소개</label>
                         	<textarea class="form-control autosize" id="blog-bio" name="description" placeholder="블로그 소개" data-autosize-on="true" style="overflow: hidden;
                         ...
                         <div class="form-group mb-2">
                                ...
                                <div class="input-group input-group-transparent">
                                    <input class="form-control" id="blog-url" name="name" value="nowaki-k" placeholder="블로그 URL">
                                </div>
