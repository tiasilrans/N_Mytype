		...
		<div class="container">
			<div class="collapse navbar-collapse header-right-menu"
				...
				<ul class="nav navbar-nav navbar-left">
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="padding: 5px;">구독</a>
						<ul class="dropdown-menu">						
							<li><a href="/subscribe/blog.mt">(미완)구독한 블로그</a></li>
							<li><a href="/subscribe/tag.mt">(미완)구독한 태그</a></li>
						</ul>
					</li> 
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="padding: 5px; padding-left: 10px; padding-right:10px;">라이브러리</a>
						<ul class="dropdown-menu">						
							<li><a href="/my/library/postgood">(미완)좋아요</a></li>
							<li><a href="/my/library/purchases">(미완)구매 항목</a></li>
						</ul>
					</li> 
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="padding: 5px; padding-left: 10px; padding-right:10px;">포인트</a>
						<ul class="dropdown-menu">						
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style="padding: 5px; padding-left: 10px; padding-right:10px;">설정</a>
						<ul class="dropdown-menu">						
							<li><a href="/my/settings/account">계정</a></li>
							<li><a href="/my/settings/profile">프로필</a></li>
							<li><a href="/my/settings/password">비밀번호</a></li>
